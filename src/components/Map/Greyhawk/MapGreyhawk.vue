...
<template>
  <map-frame class="map-greyhawk-frame" v-slot="slotProps">
    ...
    <Transition>
      <img
        class="map-greyhawk-img"
        v-if="slotProps.scale >= ZOOM['-2'] && slotProps.scale <= ZOOM['2']"
    ...
    <Transition>
      <img
        class="map-greyhawk-img"
        v-if="slotProps.scale >= ZOOM['0'] && slotProps.scale <= ZOOM['2']"
    ...
    <Transition>
      <img
        class="map-greyhawk-img"
        v-if="slotProps.scale >= ZOOM['-1'] && slotProps.scale <= ZOOM['3']"
