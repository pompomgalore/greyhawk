<template>
  ...
  <!-- <p>
    ...
    allegiance to the reigning prelate - usually a high priest. The state is only loosely organized,
    but it has a strong spirit of freedom and justice based upon religious precepts. The peoples are
    mainly farmers, herdsmen, fisherfolk, and in the far north, some foresters. Militia contingents
    bear crossbows, spears, polearms (fauchard or glaive most commonly), or longbows, and battleaxes
    for the northern contingent. Standing forces number around 5,000 total horse and foot, plus the
  ...
  <p>
    <em>King Tavish III</em> was slain in battle against the
    <a href="#hold-sea-princes">Sea Princes</a> (Siege of <a href="#westkeep">Westkeep</a>, 453 CY),
    and his son, <em>Tavish IV</em>, immediately changed the policies of the kingdom upon ascending
    to the throne. After protracted negotiations, the independent state of the
    <a href="#yeomanry">Yeomanry</a> was recognized, the Ulek states were granted autonomy, and
